...
namespace ClassSchedule.Controllers
{
    public class ClassController : Controller
    {
        ...
        public ClassController(IClassScheduleUnitOfWork unit, IHttpContextAccessor http)
        {
            data = unit;
            accessor = http;
        }
        ...
        {
            var c = this.GetClass(id);
            ViewBag.DayId = accessor.HttpContext.Session.GetInt32("dayid");
            return View(c);
        }
        ...
        private RedirectToActionResult GoToClasses()
        {
            ...
            if (accessor.HttpContext.Session.GetInt32("dayid").HasValue)
                return RedirectToAction("Index", "Home", new { id = accessor.HttpContext.Session.GetInt32("dayid") });
            else
                return RedirectToAction("Index", "Home");
        }
    }
